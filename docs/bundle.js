...
var _testPage = __webpack_require__(11);

var _testPage2 = _interopRequireDefault(_testPage);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var page = (0, _testPage2.default)();
var app_container = document.getElementById('app');
_reactDom2.default.render(page, app_container);
...
var _TestPage = __webpack_require__(12);

Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_TestPage).default;
  }
});
...
var _newsletterSignUp = __webpack_require__(13);

var _newsletterSignUp2 = _interopRequireDefault(_newsletterSignUp);

var _TestPage = __webpack_require__(51);
...
var TestPage = function TestPage() {
	...
	return _react2.default.createElement(
		'div',
		{ className: (0, _TestPage2.default)('container') },
		_react2.default.createElement(_newsletterSignUp2.default, { data: newsletter_data }),
		_react2.default.createElement(
			'a',
			{ href: './storybook', target: '_blank', className: (0, _TestPage2.default)('storybook') },
			'View UI on Storybook'
		)
	);
};
...
var _NewsletterSignUp = __webpack_require__(14);

Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_NewsletterSignUp).default;
  }
});
...
var _NewsletterSignUp = __webpack_require__(17);

var _NewsletterSignUp2 = _interopRequireDefault(_NewsletterSignUp);

var _expressiveLabel = __webpack_require__(19);

var _expressiveLabel2 = _interopRequireDefault(_expressiveLabel);

var _regularLabel = __webpack_require__(23);

var _regularLabel2 = _interopRequireDefault(_regularLabel);
...
var _textButton = __webpack_require__(35);

var _inputWithMessage = __webpack_require__(39);

var _inputWithMessage2 = _interopRequireDefault(_inputWithMessage);

var _multiStepForm = __webpack_require__(47);

var _multiStepForm2 = _interopRequireDefault(_multiStepForm);
...
var NewsletterSignUp = function (_Component) {
	_inherits(NewsletterSignUp, _Component);
	...
	function NewsletterSignUp(props) {
		...
		_this.handleStepComplete = _this.handleStepComplete.bind(_this);
		_this.handleAllComplete = _this.handleAllComplete.bind(_this);
		return _this;
	}

	_createClass(NewsletterSignUp, [{
		key: 'handleStepComplete',
		value: function handleStepComplete() {
			this.setState({
				step: this.state.step + 1
			});
		}
	}, {
		key: 'handleAllComplete',
		value: function handleAllComplete(form_data) {
			this.setState({
				step: this.state.step + 1
			});
		...
		value: function render() {
			var has_completed = this.state.step === 2;
			var container_class = (0, _NewsletterSignUp2.default)('container', 'step-' + (this.state.step + 1));

			var _props$data = this.props.data,
			    cta = _props$data.cta,
			    step_email = _props$data.step_email,
			    step_full_name = _props$data.step_full_name,
			    step_completion = _props$data.step_completion;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: (0, _NewsletterSignUp2.default)('resizer') },
					_react2.default.createElement(
						'h1',
						{ className: (0, _NewsletterSignUp2.default)('call-to-action') },
						_react2.default.createElement(_expressiveLabel2.default, { text: has_completed ? cta.congrats : cta.join_the_list })
					),
					!has_completed && _react2.default.createElement(
						_multiStepForm2.default,
						{
							initial_step: this.state.step,
							className: (0, _NewsletterSignUp2.default)('form'),
							onStepComplete: this.handleStepComplete,
							onAllComplete: this.handleAllComplete
						},
						_react2.default.createElement(
							'div',
							{ className: (0, _NewsletterSignUp2.default)('step') },
							_react2.default.createElement(
								'legend',
								{ className: (0, _NewsletterSignUp2.default)('form-label') },
								_react2.default.createElement(_regularLabel2.default, {
									typography: _regularLabel2.default.Typography.BOLD_ALL_CAPS,
									text: step_email.form_label
								})
							),
							_react2.default.createElement(_inputWithMessage2.default, {
								input: _textInput2.default,
								type: 'email',
								name: 'email',
								required: true,
								className: (0, _NewsletterSignUp2.default)('email'),
							...
							_react2.default.createElement(_inputWithMessage2.default, {
								...
								id: 'opt_in',
								className: (0, _NewsletterSignUp2.default)('opt-in'),
								label: _react2.default.createElement(
									'p',
									null,
									step_email.opt_in.message,
									' ',
									_react2.default.createElement(
										'a',
										{ target: '_blank', href: '${step_email.opt_in.link.url}' },
										step_email.opt_in.link.text
									)
								),
								invalid_message: step_email.opt_in.invalid
							}),
							_react2.default.createElement(_textButton.SubmitButton, {
								className: (0, _NewsletterSignUp2.default)('submit-button'),
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(_inputWithMessage2.default, {
								...
								required: true,
								name: 'first',
								className: (0, _NewsletterSignUp2.default)('first-name'),
							...
							_react2.default.createElement(_inputWithMessage2.default, {
								...
								required: true,
								name: 'last',
								className: (0, _NewsletterSignUp2.default)('last-name'),
					...
					has_completed && _react2.default.createElement(
						'div',
						{ className: (0, _NewsletterSignUp2.default)('sign-up-complete') },
						_react2.default.createElement(
							'p',
							null,
							_react2.default.createElement(_regularLabel2.default, {
								className: (0, _NewsletterSignUp2.default)('first-line'),
								typography: _regularLabel2.default.Typography.BOLD,
								text: step_completion.first_line
							}),
							_react2.default.createElement(_regularLabel2.default, {
								className: (0, _NewsletterSignUp2.default)('second-line'),
								typography: _regularLabel2.default.Typography.LIGHT,
...
NewsletterSignUp.propTypes = {
	data: _propTypes2.default.shape({
		cta: _propTypes2.default.shape({
			join_the_list: _propTypes2.default.string.isRequired,
			congrats: _propTypes2.default.string.isRequired
		}).isRequired,
		step_email: _propTypes2.default.shape({
			form_label: _propTypes2.default.string.isRequired,
			email: _propTypes2.default.shape({
				placeholder: _propTypes2.default.string.isRequired,
				invalid: _propTypes2.default.string.isRequired
			}).isRequired,
			opt_in: _propTypes2.default.shape({
		...
		step_full_name: _propTypes2.default.shape({
			form_label: _propTypes2.default.string.isRequired,
			first_name: _propTypes2.default.shape({
				placeholder: _propTypes2.default.string.isRequired,
				invalid: _propTypes2.default.string.isRequired
			}).isRequired,
			last_name: _propTypes2.default.shape({
				placeholder: _propTypes2.default.string.isRequired,
				invalid: _propTypes2.default.string.isRequired
			}).isRequired,
			submit: _propTypes2.default.string.isRequired
		}).isRequired,
		step_completion: _propTypes2.default.shape({
			first_line: _propTypes2.default.string.isRequired,
			second_line: _propTypes2.default.string.isRequired
		}).isRequired
	})
};
...
/***/ (function(module, exports, __webpack_require__) {
        ...
        var locals = __webpack_require__(18);
...
module.exports = {"container":"NewsletterSignUp_container","resizer":"NewsletterSignUp_resizer","step":"NewsletterSignUp_step","form-label":"NewsletterSignUp_form-label","email":"NewsletterSignUp_email","opt-in":"NewsletterSignUp_opt-in","submit-button":"NewsletterSignUp_submit-button","first-name":"NewsletterSignUp_first-name","last-name":"NewsletterSignUp_last-name","sign-up-complete":"NewsletterSignUp_sign-up-complete","first-line":"NewsletterSignUp_first-line","second-line":"NewsletterSignUp_second-line","call-to-action":"NewsletterSignUp_call-to-action","step-3":"NewsletterSignUp_step-3","form":"NewsletterSignUp_form"};
...
var _ExpressiveLabel = __webpack_require__(20);

Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_ExpressiveLabel).default;
  }
});
...
var _ExpressiveLabel = __webpack_require__(21);

var _ExpressiveLabel2 = _interopRequireDefault(_ExpressiveLabel);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ExpressiveLabel = function ExpressiveLabel(_ref) {
	var text = _ref.text,
	    style = _ref.style,
	    className = _ref.className;


	var text_class = (0, _classnames2.default)((0, _ExpressiveLabel2.default)('text'), className);

	return _react2.default.createElement(
		'span',
		{ className: text_class, style: style },
		text
	);
};
...
exports.default = ExpressiveLabel;
module.exports = exports.default;
...
/***/ (function(module, exports, __webpack_require__) {
        ...
        // classnames-loader: automatically bind css-modules to classnames
        var classNames = __webpack_require__(1);
        var locals = __webpack_require__(22);
        var css = classNames.bind(locals);
        for (var style in locals) css[style] = locals[style];
        module.exports = css;
...
// removed by extract-text-webpack-plugin
module.exports = {"text":"ExpressiveLabel_text"};
...
var _RegularLabel = __webpack_require__(24);

Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_RegularLabel).default;
  }
});
...
var _RegularLabel = __webpack_require__(25);
...
var RegularLabel = function RegularLabel(_ref) {
	var text = _ref.text,
	    style = _ref.style,
	...
	var text_class = (0, _classnames2.default)((0, _RegularLabel2.default)('text', typography), className);
...
RegularLabel.propTypes = {
	text: _propTypes2.default.string.isRequired,
	typography: _propTypes2.default.oneOf(Object.values(Typography)),
	className: _propTypes2.default.string,
	style: _propTypes2.default.object
};

exports.default = RegularLabel;
module.exports = exports.default;
...
/***/ (function(module, exports, __webpack_require__) {
        ...
        // classnames-loader: automatically bind css-modules to classnames
        var classNames = __webpack_require__(1);
        var locals = __webpack_require__(26);
        var css = classNames.bind(locals);
        for (var style in locals) css[style] = locals[style];
        module.exports = css;
...
// removed by extract-text-webpack-plugin
module.exports = {"text":"RegularLabel_text","bold_all_caps":"RegularLabel_bold_all_caps","light_all_caps":"RegularLabel_light_all_caps","bold":"RegularLabel_bold","light":"RegularLabel_light"};
...
var TextInput = function TextInput(_ref) {
	...
	var input_class = (0, _classnames2.default)((0, _TextInput2.default)('input', theme), className);
...
TextInput.propTypes = {
	...
	default_value: _propTypes2.default.string,
	theme: _propTypes2.default.oneOf(['lighter', 'darker']),
...
/***/ (function(module, exports, __webpack_require__) {
        ...
        // classnames-loader: automatically bind css-modules to classnames
        var classNames = __webpack_require__(1);
        var locals = __webpack_require__(30);
        var css = classNames.bind(locals);
        for (var style in locals) css[style] = locals[style];
        module.exports = css;
...
// removed by extract-text-webpack-plugin
module.exports = {"input":"TextInput_input","lighter":"TextInput_lighter","darker":"TextInput_darker"};
...
var Checkbox = function Checkbox(_ref) {
	var id = _ref.id,
	    name = _ref.name,
	    required = _ref.required,
	    default_checked = _ref.default_checked,
	    label = _ref.label,
	    checkbox_className = _ref.checkbox_className,
	    label_className = _ref.label_className,
	    onInvalid = _ref.onInvalid;


	var checkbox_class = (0, _classnames2.default)((0, _Checkbox2.default)('checkbox'), checkbox_className);
	var label_class = (0, _classnames2.default)((0, _Checkbox2.default)('label'), label_className);
...
Checkbox.propTypes = {
	checkbox_className: _propTypes2.default.string,
	label_className: _propTypes2.default.string,
	required: _propTypes2.default.bool,
	id: _propTypes2.default.string,
	name: _propTypes2.default.string,
	label: _propTypes2.default.node,
	default_checked: _propTypes2.default.bool,
	onInvalid: _propTypes2.default.func
};
...
/***/ (function(module, exports, __webpack_require__) {
        ...
        // classnames-loader: automatically bind css-modules to classnames
        var classNames = __webpack_require__(1);
        var locals = __webpack_require__(34);
        var css = classNames.bind(locals);
        for (var style in locals) css[style] = locals[style];
        module.exports = css;
...
// removed by extract-text-webpack-plugin
module.exports = {"checkbox":"Checkbox_checkbox","label":"Checkbox_label"};
...
exports.SubmitButton = exports.RegularButton = undefined;
...
var _TextButton = __webpack_require__(36);
...
var RegularButton = function RegularButton(props) {
	return (0, _react.createElement)(_TextButton2.default, _extends({
		type: 'button'
	}, props));
};
...
var _TextButton = __webpack_require__(37);
...
var TextButton = function (_PureComponent) {
	...
	_createClass(TextButton, [{
		key: 'render',
		value: function render() {
			var container_class = (0, _classnames2.default)((0, _TextButton2.default)('container'), this.props.className);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: (0, _TextButton2.default)('box') },
					this.props.text
				)
			);
		}
...
/***/ (function(module, exports, __webpack_require__) {
        ...
        // classnames-loader: automatically bind css-modules to classnames
        var classNames = __webpack_require__(1);
        var locals = __webpack_require__(38);
        var css = classNames.bind(locals);
        for (var style in locals) css[style] = locals[style];
        module.exports = css;
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"TextButton_container","box":"TextButton_box"};
...
var _InputWithMessage = __webpack_require__(40);

Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_InputWithMessage).default;
  }
});
...
var _invalidMessage = __webpack_require__(41);

var _invalidMessage2 = _interopRequireDefault(_invalidMessage);

var _InputWithMessage = __webpack_require__(45);
...
var InputWithMessage = function (_Component) {
	_inherits(InputWithMessage, _Component);

	function InputWithMessage(props) {
		_classCallCheck(this, InputWithMessage);

		var _this = _possibleConstructorReturn(this, (InputWithMessage.__proto__ || Object.getPrototypeOf(InputWithMessage)).call(this, props));
	...
	_createClass(InputWithMessage, [{
		...
		key: 'render',
		value: function render() {
			var container_class = (0, _classnames2.default)((0, _InputWithMessage2.default)('container', {
			...
			return _react2.default.createElement(
				'div',
				{ className: container_class },
				(0, _react.createElement)(this.props.input, _extends({}, this.props, {
					className: (0, _InputWithMessage2.default)('input'),
					onInvalid: this.handleInvalid
				})),
				this.props.invalid_message && _react2.default.createElement(_invalidMessage2.default, {
					className: (0, _InputWithMessage2.default)('message'),
...
InputWithMessage.propTypes = {
	input: _propTypes2.default.func.isRequired,
	invalid_message: _propTypes2.default.string,
	className: _propTypes2.default.string
};
exports.default = InputWithMessage;
module.exports = exports.default;
...
var _InvalidMessage = __webpack_require__(42);

Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_InvalidMessage).default;
  }
});
...
var _InvalidMessage = __webpack_require__(43);

var _InvalidMessage2 = _interopRequireDefault(_InvalidMessage);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var InvalidMessage = function InvalidMessage(_ref) {
	var text = _ref.text,
	    className = _ref.className;


	var text_class = (0, _classnames2.default)((0, _InvalidMessage2.default)('text'), className);
...
/***/ (function(module, exports, __webpack_require__) {
        ...
        // classnames-loader: automatically bind css-modules to classnames
        var classNames = __webpack_require__(1);
        var locals = __webpack_require__(44);
        var css = classNames.bind(locals);
        for (var style in locals) css[style] = locals[style];
        module.exports = css;
...
// removed by extract-text-webpack-plugin
module.exports = {"text":"InvalidMessage_text"};
...
/***/ (function(module, exports, __webpack_require__) {
        ...
        // classnames-loader: automatically bind css-modules to classnames
        var classNames = __webpack_require__(1);
        var locals = __webpack_require__(46);
        var css = classNames.bind(locals);
        for (var style in locals) css[style] = locals[style];
        module.exports = css;
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"InputWithMessage_container","invalid":"InputWithMessage_invalid","message":"InputWithMessage_message"};
...
var _MuitiStepForm = __webpack_require__(48);

Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_MuitiStepForm).default;
  }
});
...
var _MultiStepForm = __webpack_require__(49);
...
var MultiStepForm = function (_Component) {
	_inherits(MultiStepForm, _Component);

	function MultiStepForm(props) {
		_classCallCheck(this, MultiStepForm);

		var _this = _possibleConstructorReturn(this, (MultiStepForm.__proto__ || Object.getPrototypeOf(MultiStepForm)).call(this, props));

		_this.state = {
			step: _this.props.initial_step
		};
	...
	_createClass(MultiStepForm, [{
		...
		value: function handleSubmit(e) {
			...
			var form_data = {};
			var named_inputs = e.target.querySelectorAll('input[name]');
			for (var i = 0; i < named_inputs.length; i++) {
				var input = named_inputs[i];
				form_data[input.name] = input.value;
			}

			var current_step = this.state.step;
			var total_steps = _react.Children.count(this.props.children);

			var next_step = current_step + 1;
			var next_form_data = Object.assign({}, this.state.form_data, form_data);
			...
			if (current_step < total_steps - 1) {
				...
				this.setState({
					...
					_this2.props.onStepComplete(_this2.state.step);
				});
			} else {
				...
				this.setState({
					...
					_this2.props.onAllComplete(_this2.state.form_data);
				});
			}
		}
	}, {
		key: 'render',
		value: function render() {
			var form_class = (0, _classnames2.default)((0, _MultiStepForm2.default)('form'), this.props.className);
			var fieldset = this.props.children[this.state.step];

			return _react2.default.createElement(
				'form',
				{ className: form_class, onSubmit: this.handleSubmit },
				_react2.default.createElement(
					'fieldset',
					{ key: this.state.step },
					fieldset
...
MultiStepForm.propTypes = {
	initial_step: _propTypes2.default.number,
	className: _propTypes2.default.string,
	onStepComplete: _propTypes2.default.func,
	onAllComplete: _propTypes2.default.func
};
MultiStepForm.defaultProps = {
	initial_step: 0,
	onStepComplete: function onStepComplete(step) {},
	onAllComplete: function onAllComplete(form_data) {}
};
...
/***/ (function(module, exports, __webpack_require__) {
        ...
        // classnames-loader: automatically bind css-modules to classnames
        var classNames = __webpack_require__(1);
        var locals = __webpack_require__(50);
        var css = classNames.bind(locals);
        for (var style in locals) css[style] = locals[style];
        module.exports = css;
...
/***/ (function(module, exports, __webpack_require__) {
        ...
        // classnames-loader: automatically bind css-modules to classnames
        var classNames = __webpack_require__(1);
        var locals = __webpack_require__(52);
        var css = classNames.bind(locals);
        for (var style in locals) css[style] = locals[style];
        module.exports = css;
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"TestPage_container","storybook":"TestPage_storybook"};
